...
var $edbcf3072a01d580$export$adb4a1754da6f10d = /*#__PURE__*/ function(ServerMessageType) {
    ...
    ServerMessageType["GetCapabilities"] = "GETRTPCAPABILITIES";
    return ServerMessageType;
}({});


const $812644bc8c7ccc3e$export$83d89fbfd8236492 = "1.5.96";


class $5dd3b97502a89fbb$export$4798917dbf149b79 extends (0, $f5d7fbd88de797fd$exports.EventEmitter) {
    start(id, token, username) {
        this._id = id;
        ...
        this._socket.onmessage = (event)=>{
            ...
            try {
                ...
                (0, $d3fc3aacca52312c$export$2e2bcd8739ae039).log("Server message received1:", data);
                if (data.type == (0, $edbcf3072a01d580$export$adb4a1754da6f10d).Open) {
                    (0, $d3fc3aacca52312c$export$2e2bcd8739ae039).log("Open msg received");
                    const msg = {
                        dst: '',
                        src: id,
                    ...
                    (0, $d3fc3aacca52312c$export$2e2bcd8739ae039).log("sent msg back", jsonString);
                }
            } catch (e) {
...
class $11967427976ce06d$export$ecd1fc136c422448 extends (0, $41eb28b5735ed6cf$export$6a678e589c8a4542) {
    ...
    /** Initialize a connection with the server. */ _initialize(id, username) {
        this._id = id;
            ...
            case (0, $edbcf3072a01d580$export$adb4a1754da6f10d).Offer:
                {
                    ...
                    if (payload.type === (0, $edbcf3072a01d580$export$3157d57b4135e3bc).Media) {
                        ...
                        (0, $d3fc3aacca52312c$export$2e2bcd8739ae039).log("Offer with connection");
    ...
    constructor(username, id, options){
        ...
        }, this._id = null, this._username = null, this._lastServerId = null, // States.
        ...
        if (userId) this._initialize(userId, username);
