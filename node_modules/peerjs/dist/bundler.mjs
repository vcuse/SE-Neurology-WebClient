...
const $520832d44ba058c8$export$83d89fbfd8236492 = "1.5.96";
    ...
    start(id, token, username) {
        ...
        this._socket.onmessage = (event)=>{
            ...
            try {
                ...
                (0, $257947e92926277a$export$2e2bcd8739ae039).log("Server message received1:", data);
                if (data.type == (0, $78455e22dea96b8c$export$adb4a1754da6f10d).Open) {
                    (0, $257947e92926277a$export$2e2bcd8739ae039).log("Open msg received");
                    const msg = {
                        dst: '',
                        src: id,
                    ...
                    (0, $257947e92926277a$export$2e2bcd8739ae039).log("sent msg back", jsonString);
                }
            } catch (e) {
            ...
            case (0, $78455e22dea96b8c$export$adb4a1754da6f10d).Offer:
                {
                    ...
                    if (payload.type === (0, $78455e22dea96b8c$export$3157d57b4135e3bc).Media) {
                        ...
                        (0, $257947e92926277a$export$2e2bcd8739ae039).log("Offer with connection");
