...
const $3a25eea6a06ee968$export$83d89fbfd8236492 = "1.5.96";
    ...
    start(id, token, username) {
        ...
        this._socket.onmessage = (event)=>{
            ...
            try {
                ...
                (0, $df9d8b89ee908b8b$export$2e2bcd8739ae039).log("Server message received1:", data);
                if (data.type == (0, $1a7e7edd560505fc$export$adb4a1754da6f10d).Open) {
                    (0, $df9d8b89ee908b8b$export$2e2bcd8739ae039).log("Open msg received");
                    const msg = {
                        dst: '',
                        src: id,
                    ...
                    (0, $df9d8b89ee908b8b$export$2e2bcd8739ae039).log("sent msg back", jsonString);
                }
            } catch (e) {
            ...
            case (0, $1a7e7edd560505fc$export$adb4a1754da6f10d).Offer:
                {
                    ...
                    if (payload.type === (0, $1a7e7edd560505fc$export$3157d57b4135e3bc).Media) {
                        ...
                        (0, $df9d8b89ee908b8b$export$2e2bcd8739ae039).log("Offer with connection");
